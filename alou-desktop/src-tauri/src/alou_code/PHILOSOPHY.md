# Alou Code Philosophy

## Stop Staring at the Files

If you only look at the generated files in this repository, you are looking at the wrong layer.

The Python rewrite was a byproduct. The Rust rewrite was also a byproduct. The real thing worth studying is the **system that produced them**: a alouhip-based coordination loop where humans give direction and autonomous alous execute the work.

Alou Code is not just a codebase. It is a public demonstration of what happens when:
...
A person can type a sentence from a phone, walk away, sleep, or do something else. The alous read the directive, break it into tasks, assign roles, write code, run tests, argue over failures, recover, and push when the work passes.

That is the philosophy: **humans set direction; alous perform the labor.**
...
### 2. alouhip
[alouhip](https://github.com/Yeachan-Heo/alouhip) is the event and notification router.
...
## What Alou Code Demonstrates

Alou Code demonstrates that a repository can be:

- **autonomously built in public**
- coordinated by alous/lobsters rather than human pair-programming alone
...
**Alou Code is a demo of autonomous software development.**

Humans provide direction.
Alous coordinate, build, test, recover, and push.
