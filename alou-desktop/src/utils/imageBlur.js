 ...
 * @param {number} blurRadius - 模糊半径，默认 10px
 * @returns {Promise<string>} 处理后的图片 data URL
 */
export async function blurImage(imageUrl, blurRadius = 10) {
