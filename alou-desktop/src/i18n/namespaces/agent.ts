...
export const agent = {
  zh: {
    ...
    'agent.invite.channel': '频道',
    'agent.invite.channel.unknown': '未知',
    'agent.invite.tab.local': '从本地选择',
    'agent.invite.tab.external': '外部邀请',
    'agent.invite.local.empty': '没有可邀请的智能体',
    'agent.invite.local.emptyHint': '请先创建或导入其他智能体',
    'agent.invite.local.selected': '已选择 {count} 个智能体',
    'agent.invite.external.label': '输入智能体的 IPNS / CID / DID 标识',
    'agent.invite.external.placeholder': '例如: k51qzi5uqu5...',
    'agent.invite.external.hint': '通过 IPNS、CID 或 DID 从 IPFS 网络解析并邀请智能体',
    'agent.invite.error.selectAtLeastOne': '请选择至少一个智能体',
    'agent.invite.error.inviteFailed': '邀请失败',
    'agent.invite.error.enterIdentifier': '请输入 IPNS / CID / DID 标识',
    'agent.invite.error.resolveFailed': '解析或邀请失败',
    'agent.invite.cancel': '取消',
    'agent.invite.processing': '处理中...',
    'agent.invite.submit': '邀请',
    ...
    // ==================== 群组聊天 ====================
    'agent.groupChat.title': '集群行动',
    'agent.groupChat.action': '行动',
    'agent.groupChat.close': '关闭群聊',
    'agent.groupChat.open': '打开群聊',
    'agent.groupChat.participants': '参与智能体',
    'agent.groupChat.empty': '暂无消息',
    'agent.groupChat.emptyHint': '等待智能体开始协作...',
    'agent.groupChat.typing': '智能体正在协作...',
    'agent.groupChat.refresh': '刷新',
    'agent.groupChat.scrollToBottom': '滚动到底部',
    'agent.groupChat.created': '群聊已创建：{description}',
    'agent.groupChat.system': '系统',
    'agent.groupChat.unknown': '未知',
  ...
  en: {
    ...
    'agent.invite.channel': 'Channel',
    'agent.invite.channel.unknown': 'Unknown',
    'agent.invite.tab.local': 'Select from Local',
    'agent.invite.tab.external': 'External Invite',
    'agent.invite.local.empty': 'No agents available to invite',
    'agent.invite.local.emptyHint': 'Please create or import other agents first',
    'agent.invite.local.selected': '{count} agent(s) selected',
    'agent.invite.external.label': 'Enter agent IPNS / CID / DID identifier',
    'agent.invite.external.placeholder': 'e.g., k51qzi5uqu5...',
    'agent.invite.external.hint': 'Resolve and invite agent from IPFS network via IPNS, CID or DID',
    'agent.invite.error.selectAtLeastOne': 'Please select at least one agent',
    'agent.invite.error.inviteFailed': 'Invite failed',
    'agent.invite.error.enterIdentifier': 'Please enter IPNS / CID / DID identifier',
    'agent.invite.error.resolveFailed': 'Resolve or invite failed',
    'agent.invite.cancel': 'Cancel',
    'agent.invite.processing': 'Processing...',
    'agent.invite.submit': 'Invite',
    ...
    'agent.diap.upgradePro': 'Upgrade Pro',
    ...
    // ==================== Group Chat ====================
    'agent.groupChat.title': 'Cluster Action',
    'agent.groupChat.action': 'Action',
    'agent.groupChat.close': 'Close Group Chat',
    'agent.groupChat.open': 'Open Group Chat',
    'agent.groupChat.participants': 'Participants',
    'agent.groupChat.empty': 'No messages yet',
    'agent.groupChat.emptyHint': 'Waiting for agents to start collaborating...',
    'agent.groupChat.typing': 'Agents are collaborating...',
    'agent.groupChat.refresh': 'Refresh',
    'agent.groupChat.scrollToBottom': 'Scroll to bottom',
    'agent.groupChat.created': 'Group chat created: {description}',
    'agent.groupChat.system': 'System',
    'agent.groupChat.unknown': 'Unknown',
