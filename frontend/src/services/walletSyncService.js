...
export async function watchForWalletSync(onSync) {
  ...
  if (isDesktop()) {
    ...
    console.log('[WalletSync] Not in desktop environment, skipping file system polling')
  }
}
