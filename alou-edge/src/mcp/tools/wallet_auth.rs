...
impl WalletAuthTool {
    ...
    pub async fn verify_signature(
        ...
        self.wallet_auth
            .verify_and_create_token(address, signature, message, chain_type)
            .await
    }
            ...
            "verify_signature" => {
                let signature =
                    args.get("signature")
                        .and_then(|v| v.as_str())
                        .ok_or_else(|| {
                            AloudError::InvalidToolArgs("Missing 'signature' field".to_string())
                        })?;
                ...
                let message = args
                    ...
                    .and_then(|v| v.as_str())
                    .ok_or_else(|| {
                        AloudError::InvalidToolArgs("Missing 'message' field".to_string())
                    })?;
                ...
                let token = self
                    .verify_signature(address, signature, message, chain)
                    .await?;
